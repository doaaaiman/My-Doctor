...
<!--                <div class="col-2">
                ...
                <div class="col-5">
                    <a href="/patient/question/create" class="btn btn-success">Create New question</a>
                </div>
            </form>
                ...
                <table class="table mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <a href='/patient/question/{{$question->id}}/answer' class="btn btn-info btn-fw">All Answers</a>
                               </td>
                        </tr>
