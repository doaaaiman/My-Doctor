...
@section('content')
        ...
        <div class='container'>
                ...
                <form class='row'>
                     <div class="col-sm-2">
                         <a href='/admin/patients/create' class='btn  btn-primary px-3 py-2'><i class="fas fa-user-plus pr-2"></i>Create New Paient</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  class="text-center" width="20%">
                                    <a href='/admin/patients/{{$user->id}}/edit' class='btn btn-sm btn-secondary'>Edit</a>
                                    <a href='/admin/patients/{{$user->id}}/delete' class='btn btn-sm btn-danger'>Delete</a>
                                    </td>
                            </tr>
                            @endforeach
                        </tbody>
