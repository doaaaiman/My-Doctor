...
@section('content')
        ...
        <div class='container'>
                ...
                <form class='row'>
                     <div class="col-sm-2">
                         <a href='/admin/users/create' class='btn  btn-primary px-3 py-2'><i class="fas fa-user-plus pr-2"></i>Create New User</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  class="text-center" width="20%">
                                    ...
                                    <a href='/admin/users/{{$user->id}}/links' class='btn btn-sm btn-info'>Links</a>                                    
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
